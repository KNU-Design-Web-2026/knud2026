...
assert.match(component, /message-card--initial-reveal/);
assert.match(component, /INITIAL_REVEAL_CLEANUP_MS/);
...
assert.match(styles, /@keyframes message-card-initial-reveal/);
assert.match(styles, /\.message-card--initial-reveal\s*\{[\s\S]*animation-delay:\s*var\(--message-initial-reveal-delay, 0ms\)/);
...
assert.match(styles, /\.message-page\[data-message-motion-ready="true"\] \.message-list \.message-card\[data-message-reveal\]\s*\{/);
