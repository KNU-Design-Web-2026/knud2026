...
assert.match(styles, /@media \(min-width: 1350\.0625px\)[\s\S]*\.message-card__body\s*\{[\s\S]*font-size:\s*18px;[\s\S]*-webkit-line-clamp:\s*10;/);
assert.match(styles, /@media \(max-width: 1350px\)[\s\S]*\.message-card__body\s*\{[\s\S]*font-size:\s*18px;[\s\S]*-webkit-line-clamp:\s*10;/);
assert.match(styles, /@media \(max-width: 1020px\)[\s\S]*\.message-card__body\s*\{[\s\S]*font-size:\s*16px;[\s\S]*-webkit-line-clamp:\s*11;/);
assert.match(styles, /@media \(max-width: 600px\)[\s\S]*\.message-card__body\s*\{[\s\S]*font-size:\s*clamp\(0\.6875rem, 2\.167vw, 0\.8125rem\);[\s\S]*-webkit-line-clamp:\s*9;/);
assert.match(styles, /@media \(max-width: 400px\)[\s\S]*\.message-card__body\s*\{[\s\S]*font-size:\s*11px;[\s\S]*-webkit-line-clamp:\s*7;/);
