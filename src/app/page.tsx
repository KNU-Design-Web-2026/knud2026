...
export default function HomePage() {
  return (
    <section className="main-hero relative isolate h-[var(--main-hero-height)] min-h-[calc(100dvh-var(--header-height))] overflow-hidden" id="main-hero" aria-labelledby="main-title">
